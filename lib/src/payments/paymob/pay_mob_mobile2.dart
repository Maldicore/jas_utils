import 'dart:core';
import 'package:jas_utils/jas_utils.dart';
import 'package:jas_utils/src/payments/paymob/pay_mob_services.dart';
        ...
        body: WebView(
          ...
          navigationDelegate: (NavigationRequest request) {
            ...
            if (request.url.contains("txn_response_code=APPROVED")) {
              ...
              // I/flutter (29194): https://jackaservice.com/PayMob?source_data.pan=2346&is_refund=false&success=false&
              ...
              // https://jackaservice.com/PayMob?integration_id=202620&is_capture=false&source_data.pan=2346&
